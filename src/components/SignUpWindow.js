      ...
      <div className='signup-menu'>
        ...
        <div style={{display:"flex",gap:"30px"}}>
          <div className='sign-up-text-fields-area'>
            ...
            {userType==="SPO"?
            <div className='sign-up-text-field'>
              <div className='sign-up-text-field-title'>Pool ID:</div>
              <div className='sign-up-text-field-input' style={{flex:1,marginLeft:"7px"}}>
                <input type='text' id='poolIDInput' style={{width:"100%",height:"20px"}}></input>
              </div>
            </div>
            :
            <></>}
