  ...
  return (
    ...
    <div className="wallet-menu" >
      ...
      <ul className="wallet-list">
        ...
        {isEternlAvailable && (
          <li className="wallet-item">
            <button onClick={async () => {showLoadingWindow();onClose();walletAPI = await window.cardano.eternl.enable();setWalletAPI(walletAPI);setWalletIcon(window.cardano.eternl.icon);setWalletName('Eternl');Cookies.set('lastConnectedWalletName','eternl',{expires:1000});handleSelection('eternl')}}>
